#ifndef RANDOMORDERENUMERATION_Q3RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q3RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q3RandomAccessIndex, FisherYatesShuffler, Q3Answer> Q3RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q3_report.txt", ios::app);
    //out << endl;
    ...
    Q3RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q3RANDOMENUMERATIONTEST_H_H