#ifndef RANDOMORDERENUMERATION_Q7RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q7RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q7RandomAccessIndex, FisherYatesShuffler, Q7Answer> Q7RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q7_report.txt", ios::app);
    //out << endl;
    ...
    Q7RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q7RANDOMENUMERATIONTEST_H_H