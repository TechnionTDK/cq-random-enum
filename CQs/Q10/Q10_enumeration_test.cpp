#ifndef RANDOMORDERENUMERATION_Q10RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q10RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q10RandomAccessIndex, FisherYatesShuffler, Q10Answer> Q10RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q10_report.txt", ios::app);
    //out << endl;
    //out << "sample ratio [%], build time [sec], sample time [sec]" << endl;

    #ifdef PRINT
    ofstream log;
    log.open("TestsOutput/Q10_answers.csv", ios::out);
    sample_ratios = {1.0};
    #endif

    auto t1 = chrono::steady_clock::now();
    Q10RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q10RANDOMENUMERATIONTEST_H_H