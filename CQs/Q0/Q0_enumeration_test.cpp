#ifndef RANDOMORDERENUMERATION_Q0RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q0RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q0RandomAccessIndex, FisherYatesShuffler, Q0Answer> Q0RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q0_report.txt", ios::app);
    //out << endl;
    ...
    Q0RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q0RANDOMENUMERATIONTEST_H_H