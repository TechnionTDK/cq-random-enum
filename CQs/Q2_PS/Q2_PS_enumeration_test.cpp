#ifndef RANDOMORDERENUMERATION_Q2_PSRANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q2_PSRANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q2_PSRandomAccessIndex, FisherYatesShuffler, Q2_PSAnswer> Q2_PSRandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q2_PS_report.txt", ios::app);
    //out << endl;
    //out << "sample ratio [%], build time [sec], sample time [sec]" << endl;

    #ifdef PRINT
    ofstream log;
    log.open("TestsOutput/Q2_PS_answers.csv", ios::out);
    sample_ratios = {1.0};
    #endif

    auto t1 = chrono::steady_clock::now();
    Q2_PSRandomOrderEnumeration enume;
    ...
    cout << "first answer = " << enume.access(0).to_string() << endl;
...
#endif //RANDOMORDERENUMERATION_Q2_PSRANDOMENUMERATIONTEST_H_H