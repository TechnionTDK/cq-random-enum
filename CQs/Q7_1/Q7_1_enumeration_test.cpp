#ifndef RANDOMORDERENUMERATION_Q7_1RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q7_1RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q7_1RandomAccessIndex, FisherYatesShuffler, Q7_1Answer> Q7_1RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q7_1_report.txt", ios::app);
    //out << endl;
    ...
    Q7_1RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q7_1RANDOMENUMERATIONTEST_H_H