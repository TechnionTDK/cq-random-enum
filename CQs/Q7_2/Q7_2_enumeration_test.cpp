#ifndef RANDOMORDERENUMERATION_Q7_2RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q7_2RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q7_2RandomAccessIndex, FisherYatesShuffler, Q7_2Answer> Q7_2RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q7_2_report.txt", ios::app);
    //out << endl;
    //out << "sample ratio [%], build time [sec], sample time [sec]" << endl;

#ifdef PRINT
    ofstream log;
    log.open("/home/shaizeevi/Q7_2.csv", ios::out);
    sample_ratios = {1.0};
    assert(!log.fail());
#endif

    auto t1 = chrono::steady_clock::now();
    Q7_2RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q7_2RANDOMENUMERATIONTEST_H_H