#ifndef RANDOMORDERENUMERATION_Q9RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q9RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q9RandomAccessIndex, FisherYatesShuffler, Q9Answer> Q9RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q9_report.txt", ios::app);
    //out << endl;
    //out << "sample ratio [%], build time [sec], sample time [sec]" << endl;

    #ifdef PRINT
    ofstream log;
    log.open("TestsOutput/Q9_answers.csv", ios::out);
    sample_ratios = {1.0};
    #endif

    auto t1 = chrono::steady_clock::now();
    Q9RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q9RANDOMENUMERATIONTEST_H_H