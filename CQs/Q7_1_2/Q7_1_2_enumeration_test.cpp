#ifndef RANDOMORDERENUMERATION_Q7_1_2RANDOMENUMERATIONTEST_H_H
#define RANDOMORDERENUMERATION_Q7_1_2RANDOMENUMERATIONTEST_H_H
...
typedef RandomOrderEnumeration<Q7_1_2RandomAccessIndex, FisherYatesShuffler, Q7_1_2Answer> Q7_1_2RandomOrderEnumeration;
typedef long long ll;
...
int main() {
    ...
    // open output file
    ofstream out;
    out.open("TestsOutput/Q7_1_2_report.txt", ios::app);
    //out << endl;
    //out << "sample ratio [%], build time [sec], sample time [sec]" << endl;

    #ifdef PRINT
    ofstream log;
    log.open("TestsOutput/Q7_1_2_answers.csv", ios::out);
    sample_ratios = {1.0};
    #endif

    auto t1 = chrono::steady_clock::now();
    Q7_1_2RandomOrderEnumeration enume;
...
#endif //RANDOMORDERENUMERATION_Q7_1_2RANDOMENUMERATIONTEST_H_H