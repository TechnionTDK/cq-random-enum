...
#include "../../CQs/Q7_1_2/files/Q7_1_2Answer.h"
...
struct UCQAnswer {
    ...
    //UCQAnswer() : orderKey(0), custKey(0), nationKey1(0), nationKey2(0), partKey(0), suppKey(0), lnumber(0), n1_name(""), n2_name("") {};
    ...
    UCQAnswer(const Q7_1_2Answer& a) : orderKey(a.orderKey), custKey(a.custKey), nationKey1(a.nationKey1), nationKey2(a.nationKey2),
    partKey(a.partKey), suppKey(a.suppKey), lnumber(a.lnumber), n1_name(a.n1_name), n2_name(a.n2_name) {};
  ...
  template<> Q7_1_2Answer UCQAnswer::unwrap<Q7_1_2Answer>() const {
      return {orderKey, custKey, nationKey1, nationKey2, partKey, suppKey, lnumber, n1_name, n2_name};
  }
